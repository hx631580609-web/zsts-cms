...
export const CONTENT_ITEMS: ContentItem[] = [
  {
    ...
    content: '沙特阿拉伯作为中东地区最大的经济体，近年来不断优化商务签证政策...',
    summary: '全面介绍2026年沙特商务签证的申请条件、所需材料、办理流程及注意事项',
    coverImage: '',
    images: [],
    category: '沙特签证',
    tags: ['沙特', '商务签证', '2026'],
  ...
  {
    id: '2',
    title: '中东商旅出行必备清单：从行李到保险',
    content: '前往中东地区出差，除了常规的商务准备，还有一些特别的注意事项...',
    summary: '中东商旅行前必备清单，涵盖行李、保险、着装、礼仪等全方位准备',
    coverImage: '',
    images: [],
    category: '中东商旅',
    tags: ['中东', '商旅', '出行清单'],
    ...
    aiOptimized: true,
    aiPrompt: '改成更口语化，增加emoji',
    status: '已生成',
    generatedTypes: ['文章', '海报'],
    hasVideo: false,
  ...
  {
    id: '3',
    title: '沙特工作签证与商务签证的区别详解',
    content: '很多申请人容易混淆沙特的工作签证和商务签证...',
    summary: '对比沙特工作签证与商务签证的适用场景、申请条件和有效期差异',
    coverImage: '',
    images: [],
    category: '沙特签证',
    tags: ['沙特', '工作签证', '商务签证'],
  ...
  {
    id: '4',
    title: '沙特新签证政策解读：电子签落地实施',
    content: '沙特阿拉伯近日正式宣布电子签证系统的全面落地...',
    summary: '解读沙特电子签证新政，分析对商务出行的影响和申请流程变化',
    coverImage: '',
    images: [],
    category: '政策解读',
    tags: ['沙特', '电子签证', '政策解读'],
  ...
  {
    id: '5',
    title: '吉达商务区酒店推荐：高性价比与位置并重',
    content: '吉达作为沙特的商业中心，拥有众多适合商务人士的酒店...',
    summary: '精选吉达商务区10家高性价比酒店，兼顾交通便利与商务设施',
    coverImage: '',
    images: [],
    category: '出行指南',
    tags: ['吉达', '酒店', '商务出行'],
