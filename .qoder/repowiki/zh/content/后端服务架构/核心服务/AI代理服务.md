...
- [business-core/cms-server-go/main.go:233-273](file://business-core/cms-server-go/main.go#L233-L273)
- [business-core/cms-server-go/main.go:275-285](file://business-core/cms-server-go/main.go#L275-L285)
...
## 架构总览
AI代理服务采用“前端Next.js → 后端代理（Node/Express 或 Go/Gin）→ 下游AI服务”的三层架构。认证与请求透传在代理层完成，前端通过标准API路由与代理交互。
...
图表来源
- [business-core/cms-server/app.js:168-213](file://business-core/cms-server/app.js#L168-L213)
- [business-core/cms-server-go/main.go:233-285](file://business-core/cms-server-go/main.go#L233-L285)
...
章节来源
- [business-core/cms-server/app.js:168-196](file://business-core/cms-server/app.js#L168-L196)
- [business-core/cms-server/app.js:203-212](file://business-core/cms-server/app.js#L203-L212)
- [business-core/cms-server-go/main.go:233-285](file://business-core/cms-server-go/main.go#L233-L285)
...
- [business-core/cms-server/app.js:187-194](file://business-core/cms-server/app.js#L187-L194)
- [business-core/cms-server-go/main.go:260-267](file://business-core/cms-server-go/main.go#L260-L267)
...
章节来源
- [business-core/cms-server/app.js:198-201](file://business-core/cms-server/app.js#L198-L201)
- [business-core/cms-server-go/main.go:217-224](file://business-core/cms-server-go/main.go#L217-L224)
...
## 结论
本AI代理服务通过“三路认证 + 请求透传 + WebSocket支持”实现了安全、灵活、可扩展的AI内容生成集成方案。前端Next.js路由负责调用与封装，后端代理负责认证与转发，Go/Node两种实现满足不同部署需求。通过合理的配置与最佳实践，可稳定支撑文章与图像生成、实时通信等场景。
...
- Go/Gin
  - 代理目标：通过环境变量AI_PROXY_URL配置
  - 认证顺序与透传逻辑同Node版本

章节来源
- [business-core/cms-server/app.js:198-213](file://business-core/cms-server/app.js#L198-L213)
- [business-core/cms-server-go/main.go:210-290](file://business-core/cms-server-go/main.go#L210-L290)
- [business-core/cms-server-go/config/config.go:52](file://business-core/cms-server-go/config/config.go#L52)